...
## گزینه‌های استفاده :
AUTO ATTACK : از این گزینه می‌توانید حمله به لیست مجوزهای پیش‌فرض ابزار را شروع کنید.
MANUAL ATTACK : از این گزینه می‌توانید لیست عبور دستی را انتخاب کرده و حمله را امتحان کنید.
>  **راهنما**                        

>1:بعد از اجرای دستورات بالا در قسمت 'enter Instagram username`یوزرنیم رو بنویسید و اینتر بزنید.

>2:در مرحله بعدی از بین 2 گزینه MANUAL ATTACK و AUTO ATTACK یکی رو انتخاب کنید.

>2-1: در صورتی که گزینه 2 رو انتخاب کردید روی لینک بزنید تا اموزش این قسمت رو ببینید. 
[لینک](https://play.google.com/store/apps/details?id=com.termux)|
